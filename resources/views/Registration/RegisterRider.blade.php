<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register.rider') }}" enctype=multipart/form-data>
            ...
            <!-- Name -->
            <div>
                <x-label for="fist_name" :value="__('First Name')" />
            ...
            <div class="mt-4">
                ...
                <x-input id="adress" class="block mt-1 w-full" type="text" name="address" :value="old('address')" required autofocus />
            </div>

            <!-- Roadtax -->
            <div class="mt-4">
                <x-label for="roadtax" :value="__('Roadtax')" />
                <x-input type="file" id="roadtax" class="block mt-1 w-full" name="roadtax" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input type="file" id="license" class="block mt-1 w-full" name="license" required />  
            </div>
