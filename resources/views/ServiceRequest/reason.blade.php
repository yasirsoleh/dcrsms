            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="overflow-x-auto">
                        ...
                        <form action="{{ route('service_request.staff_not_approve',['service_request'=>$service_request]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <textarea class="textarea textarea-bordered min-w-full" name="rejection_reason" style="min-height:100px" placeholder="Rejection Reason"></textarea>
