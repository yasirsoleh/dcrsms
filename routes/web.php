...
Route::prefix('/service_request')->group(function () {
    ...
    Route::get('/{service_request}', [ServiceRequestController::class, 'destroy'])
        ->name('service_request.delete');

    Route::prefix('/{service_request}/quotation')->group(function () {
        ...
        Route::get('/{quotation}/edit', [QuotationController::class, 'edit'])
            ->name('quotation.edit');
        Route::put('/{create}', [QuotationController::class, 'update'])
            ->name('quotation.update');
        Route::get('/{quotation}', [QuotationController::class, 'destroy'])
            ->name('quotation.delete');
    });

    Route::prefix('/{service_request}/pick_up')->group(function () {
        ...
        Route::get('/{pick_up}/edit', [PickUpController::class, 'edit'])
            ->name('pick_up.edit');
        Route::put('/{create}', [PickUpController::class, 'update'])
            ->name('pick_up.update');
        Route::get('/{pick_up}', [PickUpController::class, 'destroy'])
            ->name('pick_up.delete');
    });

    Route::prefix('/{service_request}/repair')->group(function () {
        ...
        Route::put('/{create}', [RepairController::class, 'update'])
            ->name('repair.update');
        Route::get('/{repair}', [RepairController::class, 'destroy'])
            ->name('repair.delete');
    });

    Route::prefix('/{service_request}/delivery')->group(function () {
        ...
        Route::get('/{delivery}/edit', [DeliveryController::class, 'edit'])
            ->name('delivery.edit');
        Route::put('/{create}', [DeliveryController::class, 'update'])
            ->name('delivery.update');
        Route::get('/{repair}', [DeliveryController::class, 'destroy'])
            ->name('delivery.delete');
    });

    Route::prefix('/{service_request}/payment')->group(function () {
        ...
        Route::get('/{payment}/edit', [PaymentController::class, 'edit'])
            ->name('payment.edit');
        Route::put('/{create}', [PaymentController::class, 'update'])
            ->name('payment.update');
        Route::get('/{repair}', [PaymentController::class, 'destroy'])
            ->name('payment.delete');
    });
});
